...
Browsers only reveal the full list of audio devices once microphone access has been granted. That’s why gatedDAW needs to
request microphone permission before you can select inputs. We recommend allowing this access permanently when prompted,
as it makes working with gatedDAW much smoother.
...
hidden. This is how browsers are designed. Granting microphone access ensures gatedDAW can list
