...
gatedDAW is available **under two alternative license terms**:

| Option                    | When to choose it                                                                                                    | Obligations                                                                                                                                                                                                                                                       |
|---------------------------|----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **A. AGPL v3 (or later)** | You are happy for the entire work that includes gatedDAW to be released under AGPL-compatible open-source terms.      | – Must distribute complete corresponding source code under AGPL.<br>– Must keep copyright & licence notices.<br>– Applies both to distribution **and** to public use via network/SaaS (§13).<br>– May run gatedDAW privately in any software, open or closed (§0). |
| **B. Commercial Licence** | You wish to incorporate gatedDAW into **closed-source** or otherwise licence-incompatible software or SaaS offerings. | – Pay the agreed fee.<br>– No copyleft requirement for your own source code.<br>– Other terms as per the signed agreement.                                                                                                                                        |
...
If you redistribute or run modified versions of gatedDAW for public use **without** a commercial license, the AGPL v3
terms apply automatically.

## Components excluded from the Commercial License

The components below ship with gatedDAW but are **not** covered by Option B (Commercial License). Their upstream
licenses are copyleft, or they depend on a third-party service whose terms cannot be sublicensed by gatedDAW. A
